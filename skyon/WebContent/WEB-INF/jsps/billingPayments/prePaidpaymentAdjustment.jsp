...
<kendo:grid name="grid" remove="adjustmentsDeleteEvent" change="onChangeAdjustments" pageable="true" resizable="true" edit="paymentAdjustmentEvent" dataBound="paymentAdjustmentDataBound" sortable="true" reorderable="true" selectable="true" scrollable="true" filterable="false" groupable="true">
	...
	<kendo:grid-columns>
	    ...
	    <kendo:grid-column title="Property&nbsp;No&nbsp;*" field="property_No" width="95px" filterable="true" >
	    ...
	    <kendo:grid-column title="Property&nbsp;No&nbsp;*" field="propertyId" hidden="true" width="140px" filterable="true" editor="propertyNumberEditor">
	    </kendo:grid-column>
	    ...
	    <kendo:grid-column title="Consumer&nbsp;No&nbsp;*" field="consumerId" filterable="true"  width="90px" >
		</kendo:grid-column>	
