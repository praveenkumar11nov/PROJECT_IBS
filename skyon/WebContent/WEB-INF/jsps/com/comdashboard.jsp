...
<link rel="stylesheet" href="<c:url value='/resources/windows8/css/demo-styles.css'/>" />
  <script src="<c:url value='/resources/windows8/js/modernizr-1.5.min.js'/>"></script>
    ...
    <ul class="tiles">
      <div class="col1 clearfix">
        ...
        <li class="tile tile-big tile-4 fig-tile" data-page-type="r-page" data-page-name="random-r-page">
          <figure>
            <img src="<c:url value='/resources/windows8/images/blue.jpg'/>" />
      ...
      <div class="col3 clearfix">      
        <li class="tile tile-2xbig tile-9 fig-tile" data-page-type="custom-page" data-page-name="random-r-page">
          <figure>
            <img src="<c:url value='/resources/windows8/images/summer.jpg'/>" />
...
<!--====================================end demo wrapper================================================-->
  <script src="<c:url value='/resources/windows8/js/jquery-1.8.2.min.js'/>"></script>
  <script src="<c:url value='/resources/windows8/js/scripts.js'/>"></script>