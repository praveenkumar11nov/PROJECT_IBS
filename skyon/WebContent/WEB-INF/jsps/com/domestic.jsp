...
<!-- Urls for Users  -->
<c:url value="/users/getPersonFullNamesList"
	var="personFullNameFilterUrl" />
...
<c:url value="/dom/address/delete" var="deleteAddressUrl" />
...
<c:url value="/dom/contact/delete" var="deleteContactUrl" />
...
<c:url value="/dom/accesscard/delete" var="AccessCardDeleteUrl" />
<c:url value="/accesscards/getAllAccessCards" var="readAccessCards" />

<!-- Access card permission Grid Access Urls -->
<c:url value="/comowner/accesscardspermisions/read"
	var="AccessCardsPermissionsReadUrl" />
<c:url value="/comowner/accesscardspermisions/create"
	var="AccessCardsPermissionCreateUrl" />
<c:url value="/comowner/accesscardspermisions/update"
	var="AccessCardsPermissionUpdateUrl" />
<c:url value="/dom/accesscardspermisions/delete"
	var="AccessCardsPermissionDeleteUrl" />
<c:url value="/comowner/getAccessCardsBasedOnPersonId"
	var="getAccessCardsBasedOnPersonId" />
<c:url value="/comowner/accessrepositoryread/read"
	var="readAccessRepositoryUrl" />

<!-- Domestic help Property Grid Access Urls -->
<c:url value="/comdomestichelp/property/read"
	var="domesticPropertyReadUrl" />
<c:url value="/comdomestichelp/property/create"
	var="domesticPropertyCreateUrl" />
<c:url value="/comdomestichelp/property/update"
	var="domesticPropertyUpdateUrl" />
<c:url value="/comdomestichelp/property/delete"
	var="domesticPropertyDeleteUrl" />
<c:url value="/comdomestichelp/getWorkNatures" var="workNatureUrl" />
...
<c:url value="/documentDefiner/getDocumentFormat"
	var="getDocumentTypeFormat" />

<!-- Medical Emergency Disability Grid Access Urls -->
<c:url value="/medicalEmergencyDisability/read"
	var="readMedicalEmergencyDisabilityUrl" />
<c:url value="/medicalEmergencyDisability/create"
	var="createMedicalEmergencyDisabilityUrl" />
<c:url value="/medicalEmergencyDisability/update"
	var="updateMedicalEmergencyDisabilityUrl" />
<c:url value="/dom/medicalEmergencyDisability/delete"
	var="deleteMedicalEmergencyDisabilityUrl" />
...
<c:url value="/dom/arms/delete" var="deleteArmsUrl" />

<!-- -------------------------------------------------- Grid data ------------------------------------------------------- -->

<kendo:grid name="gridPersonDomesticHelp" edit="personEventDomesticHelp" change="onChangeDomesticHelp" pageable="true" resizable="true"  detailTemplate="personTemplateDomesticHelp"
	sortable="true" reorderable="true" selectable="true" scrollable="true" groupable="true" filterable="true" navigatable="true">
		<kendo:grid-pageable pageSizes="true" buttonCount="5" pageSize="10" input="true" numeric="true" refresh="true" info="true" previousNext="true">
			<kendo:grid-pageable-messages itemsPerPage="Domestic Helps per page" empty="No Domestic Help to display" refresh="Refresh all the Domestic Helps" 
			display="{0} - {1} of {2} Domestic Helps" first="Go to the first page of Domestic Helps" last="Go to the last page of Domestic Helps" next="Go to the next page of Domestic Helps"
			previous="Go to the previous page of Domestic Helps"/>
		</kendo:grid-pageable> 
	...
	<kendo:grid-toolbar>
		<kendo:grid-toolbarItem name="create" text="Add DomesticHelp" />
					 <kendo:grid-toolbarItem name="domesticTemplatesDetailsExport" text="Export To Excel" />
					  <kendo:grid-toolbarItem name="domesticPdfTemplatesDetailsExport" text="Export To PDF" /> 
		<kendo:grid-toolbarItem
			template="<a class='k-button' href='\\#' onclick=clearFilterDomesticHelp()><span class='k-icon k-i-funnel-clear'></span> Clear Filter</a>" />
	...
	<kendo:grid-columns>
		...
		<kendo:grid-column title="Image" field="image"
			template="<span onclick='clickToUploadImage()' title='Click to Upload Image' ><img src='./person/getpersonimage/#=personId#' id='myImages_#=personId#' alt='Click to Upload Image' width='80px' height='80px'/></span>"
		...
		<kendo:grid-column title="First&nbsp;Name&nbsp;*" field="firstName"
			width="0px" editor="firstNameEditorDomesticHelp" hidden="true" />

		<kendo:grid-column title="Middle&nbsp;Name" field="middleName"
						...
						function fatherNameFilter(element) {
							element
									.kendoAutoComplete({
										...
										dataSource : {
											transport : {
												read : "${filterAutoCompleteUrl}/DomesticHelp/fatherName"
											}
										}
									});
						}
		...
		<kendo:grid-column title="Date&nbsp;of&nbsp;Birth&nbsp;*" field="dob"
			format="{0:dd/MM/yyyy}" width="100px" />

		<kendo:grid-column title="Age&nbsp;*" template="#=ageDisplay(data)#"
			field="age" width="60px" />
	...
	<kendo:dataSource requestStart="onRequestStartPersonDomesticHelp"
		requestEnd="onRequestEndPersonDomesticHelp">
		<kendo:dataSource-transport>
			<kendo:dataSource-transport-read url="${readPersonUrl}/DomesticHelp"
				dataType="json" type="POST" contentType="application/json" />
			<kendo:dataSource-transport-create
				url="${modifyPersonUrl}/create/DomesticHelp" dataType="json"
				type="GET" contentType="application/json" />
			<kendo:dataSource-transport-update
				url="${modifyPersonUrl}/update/DomesticHelp" dataType="json"
				type="GET" contentType="application/json" />
		</kendo:dataSource-transport>
			...
			<kendo:dataSource-schema-model id="personId">
				<kendo:dataSource-schema-model-fields>
					...
					<kendo:dataSource-schema-model-field name="personType"
						type="string" defaultValue="DomesticHelp" editable="false" />
					<kendo:dataSource-schema-model-field name="personStyle"
					...
					<kendo:dataSource-schema-model-field name="maritalStatus"
						defaultValue="None" />
					...
					<kendo:dataSource-schema-model-field name="nationality"
						defaultValue="None" />
					<kendo:dataSource-schema-model-field name="bloodGroup"
						defaultValue="None" />
					<kendo:dataSource-schema-model-field name="occupation"
						type="string" defaultValue="None" />
					<kendo:dataSource-schema-model-field name="workNature"
						defaultValue="None" />
					...
					<kendo:dataSource-schema-model-field name="personStatus"
						type="string" defaultValue="Inactive" />
...
<kendo:grid-detailTemplate id="personTemplateDomesticHelp">
	<kendo:tabStrip name="tabStrip_#=personId#">
		<kendo:tabStrip-items>
				...
				<kendo:tabStrip-item-content>
					<div class="wethear" >
						<kendo:grid name="gridAddress_#=personId#" pageable="true"
							edit="addressEvent" resizable="true" sortable="true" remove="removeAddress"
							...
							<kendo:grid-columns>
								...
								<kendo:grid-column title="&nbsp;" width="100px">
									<kendo:grid-column-command>
										<kendo:grid-column-commandItem name="Contacts"
											click="contactInfo" />
									</kendo:grid-column-command>
								</kendo:grid-column>
								...
								<kendo:grid-column title="Address&nbsp;Line&nbsp;1&nbsp;*"
									field="address1" editor="address1Editor" width="0px"
									hidden="true" />
								<kendo:grid-column title="Address&nbsp;Line&nbsp;2"
									field="address2" editor="address2Editor" width="0px"
									hidden="true" />
								<kendo:grid-column title="Address&nbsp;Line&nbsp;3"
									field="address3" editor="address3Editor" width="0px"
									hidden="true" />
								...
								<kendo:dataSource-schema parse="parseAddress">
									<kendo:dataSource-schema-model id="addressId">
										<kendo:dataSource-schema-model-fields>
											...
											<kendo:dataSource-schema-model-field name="addressSeasonFrom"
				...
				<kendo:tabStrip-item-content>
					<div class="wethear" >
						<kendo:grid name="gridContact_#=personId#" pageable="true"
							edit="contactEvent" resizable="true" sortable="true" remove="removeContact"
							reorderable="true" selectable="true" scrollable="true">
							<kendo:grid-pageable pageSize="10"></kendo:grid-pageable>
							<kendo:grid-editable mode="popup"
								...
								<kendo:dataSource-schema parse="parseContact">
									<kendo:dataSource-schema-model id="contactId">
										<kendo:dataSource-schema-model-fields>
											...
											<kendo:dataSource-schema-model-field name="contactSeasonFrom"
												type="date" defaultValue="">
												<kendo:dataSource-schema-model-field-validation />
											</kendo:dataSource-schema-model-field>
			...
			<kendo:tabStrip-item text="Property">
				<kendo:tabStrip-item-content>
					<div class="wethear" >
						...
						<kendo:grid name="grid2_#=personId#" pageable="true"
							edit="propertyEvent" resizable="true" sortable="true"
							reorderable="true" selectable="true" scrollable="true">
							<kendo:grid-pageable pageSize="10"></kendo:grid-pageable>
							<kendo:grid-editable mode="popup"
							...
							<kendo:grid-columns>
								...
								<%--  <kendo:grid-column title="Tower Name" field="propertyId" hidden="true" editor="TowerNames" width="100px" />
										 <kendo:grid-column title="Property Number" field="propertyNo" editor="propertyNoEditor"  width="100px"/>
										  ...
										  --%>
								<kendo:grid-column title="Tower Name&nbsp;*" field="blockId"
									hidden="true" editor="TowerNames" width="100px" />
								<kendo:grid-column title="Property Number&nbsp;*" field="propertyId"
									hidden="true" editor="propertyNoEditor" width="100px" />
								<kendo:grid-column title="Property Number&nbsp;*" field="propertyNo"
									width="100px" />

								<kendo:grid-column title="Work Nature&nbsp;*" field="workNature"
									width="100px" filterable="false" editor="workNatureEditor"></kendo:grid-column>
								<kendo:grid-column title="Start Date&nbsp;*" field="startDate"
									format="{0:dd/MM/yyyy}" width="100px" filterable="false"></kendo:grid-column>
								<kendo:grid-column title="End Date&nbsp;*" format="{0:dd/MM/yyyy}"
									field="endDate" width="100px" filterable="false"></kendo:grid-column>
								<kendo:grid-column title="&nbsp;" width="100px">
									<kendo:grid-column-command>
										<kendo:grid-column-commandItem name="edit" />
										<kendo:grid-column-commandItem name="destroy" />
							...
							<kendo:dataSource requestEnd="onRequestEndProperty" requestStart="onRequestStart">
								<kendo:dataSource-transport>
									<kendo:dataSource-transport-read
										url="${domesticPropertyReadUrl}/#=personId#" dataType="json"
										type="POST" contentType="application/json" />
									<kendo:dataSource-transport-create
										url="${domesticPropertyCreateUrl}/#=personId#" dataType="json"
										type="POST" contentType="application/json" />
									<kendo:dataSource-transport-update
										url="${domesticPropertyUpdateUrl}/#=personId#" dataType="json"
										type="POST" contentType="application/json" />
									<kendo:dataSource-transport-destroy
										url="${domesticPropertyDeleteUrl}/#=personId#" dataType="json" type="POST"
								...
								<kendo:dataSource-schema>
									<kendo:dataSource-schema-model id="domasticPropertyId">
										<kendo:dataSource-schema-model-fields>
											<kendo:dataSource-schema-model-field
												name="domasticPropertyId" editable="false" />
											<kendo:dataSource-schema-model-field name="domasticId">
												<kendo:dataSource-schema-model-field-validation
													required="true" />
											</kendo:dataSource-schema-model-field>
											...
											<kendo:dataSource-schema-model-field name="startDate"
												type="date" defaultValue="">
												<kendo:dataSource-schema-model-field-validation
													required="true" />
											</kendo:dataSource-schema-model-field>
											<kendo:dataSource-schema-model-field name="endDate"
												type="date" defaultValue="">
												<kendo:dataSource-schema-model-field-validation
													required="true" />
											</kendo:dataSource-schema-model-field>
											...
											<kendo:dataSource-schema-model-field name="status"
												type="string"></kendo:dataSource-schema-model-field>
			...
			<kendo:tabStrip-item text="Access Cards">
				<kendo:tabStrip-item-content>
					<div class="wethear" >
						...
						<kendo:grid name="gridAccessCard_#=personId#" pageable="true"
							edit="accessCardEvent" resizable="true" sortable="true"
							reorderable="true" selectable="true" scrollable="true">
							<kendo:grid-pageable pageSize="10"></kendo:grid-pageable>
							<kendo:grid-editable mode="popup"
							...
							<kendo:grid-columns>
								...
								<kendo:grid-column title="Access Card&nbsp;*" field="acId"
									hidden="true" editor="accessCardsEditor"></kendo:grid-column>
								<kendo:grid-column title="Access Card&nbsp;*" field="acNo"
							...
							<kendo:dataSource requestEnd="AccessCardsRequestEnd" requestStart="AccessCardsResquestStart">
								<kendo:dataSource-transport>
									<kendo:dataSource-transport-read
										url="${AccessCardReadUrl}/#=personId#" dataType="json"
										type="POST" contentType="application/json" />
									<kendo:dataSource-transport-create
										url="${AccessCardCreateUrl}/#=personId#" dataType="json"
										type="POST" contentType="application/json" />
									<kendo:dataSource-transport-update
										url="${AccessCardUpdateUrl}/#=personId#" dataType="json"
										type="POST" contentType="application/json" />
									<kendo:dataSource-transport-destroy
										url="${AccessCardDeleteUrl}" dataType="json" type="POST"
										contentType="application/json" />
									<kendo:dataSource-transport-parameterMap>
										<script type="text/javascript">
											function parameterMap(options, type) {
								...
								<kendo:dataSource-schema>
									<kendo:dataSource-schema-model id="personacId">
										<kendo:dataSource-schema-model-fields>
											<kendo:dataSource-schema-model-field name="personacId"
			...
			<kendo:tabStrip-item text="Access Cards Permissions">
				<kendo:tabStrip-item-content>
					<div class='wethear'>
						...
						<kendo:dropDownList name="accessCardAssigned_#=personId#"
							dataBound="setFirstSelected" optionLabel="Select Card"
							select="handleChange" dataTextField="acNo" dataValueField="acId"
							style="width:250px">
							<kendo:dataSource>
								<kendo:dataSource-transport>
									<kendo:dataSource-transport-read
										url="${getAccessCardsBasedOnPersonId}/#=personId#" type="POST"
										contentType="application/json" />
									<kendo:dataSource-transport-parameterMap>
										<script type="text/javascript">
						...
						<br />
						<kendo:grid name="gridAccessCardPermission_#=personId#"
							pageable="true" edit="accessCardPermissionEvent" resizable="true"
							...
							<kendo:grid-columns>
								...
								<kendo:grid-column title="Access Repository&nbsp;*"
									editor="accessRepoEditor" hidden="true" width="0px"
									field="arId"></kendo:grid-column>
								<kendo:grid-column title="Access Repository&nbsp;*" field="acPointName"></kendo:grid-column>
								<kendo:grid-column title="Start Date&nbsp;*" field="acpStartDate"
									format="{0:dd/MM/yyyy}" filterable="true" width="100px" />
								<kendo:grid-column title="End Date&nbsp;*" field="acpEndDate"
									format="{0:dd/MM/yyyy}" filterable="true" width="100px" />
								<kendo:grid-column title="Status&nbsp;*" field="status"
									editor="statusEditor"></kendo:grid-column>
							...
							<kendo:dataSource requestEnd="AccessCardsPermissionRequestEnd" requestStart="AccessCardsPermissionsRequestStart">
								<kendo:dataSource-transport>
									<kendo:dataSource-transport-read
										url="${AccessCardsPermissionsReadUrl}" dataType="json"
										type="GET" contentType="application/json" />
									<kendo:dataSource-transport-create
										url="${AccessCardsPermissionCreateUrl}" dataType="json"
										type="GET" contentType="application/json" />
									<kendo:dataSource-transport-update
										url="${AccessCardsPermissionUpdateUrl}" dataType="json"
										type="GET" contentType="application/json" />
									<kendo:dataSource-transport-destroy
										url="${AccessCardsPermissionDeleteUrl}/" dataType="json"
										type="GET" contentType="application/json" />
									<%-- <kendo:dataSource-transport-parameterMap>
						                	<script type="text/javascript">
							                	function parameterMap(options,type) 
								...
								<kendo:dataSource-schema parse="accessCardPemissionParse">
									<kendo:dataSource-schema-model id="acpId">
										<kendo:dataSource-schema-model-fields>
											<kendo:dataSource-schema-model-field name="acpId"
												type="number" />
											<%-- <kendo:dataSource-schema-model-field name="personId" type="number"></kendo:dataSource-schema-model-field>   --%>
											<kendo:dataSource-schema-model-field name="arId"
												type="number">
												<kendo:dataSource-schema-model-field-validation
													required="true" />
											</kendo:dataSource-schema-model-field>
											<kendo:dataSource-schema-model-field name="acpStartDate"
												type="date" defaultValue="">
												<%-- <kendo:dataSource-schema-model-field-validation
													required="true" /> --%>
											</kendo:dataSource-schema-model-field>
											<kendo:dataSource-schema-model-field name="acpEndDate"
												type="date" defaultValue="">
												<%-- <kendo:dataSource-schema-model-field-validation
													required="true" /> --%>
											</kendo:dataSource-schema-model-field>
			...
			<kendo:tabStrip-item text="Documents">
				<kendo:tabStrip-item-content>
					<div class='wethear'>
						    ...
						    <br/>
						    <br/>
						<kendo:grid name="documentsUpload_#=personId#" pageable="true" remove="removeDocument"
							edit="documentEvent" dataBound="UploadFileBound" resizable="true"
							sortable="true" reorderable="true" change="documentChangeEvent"
							...
							<kendo:grid-columns>
								...
								<kendo:grid-column title="Document Name&nbsp;*" field="documentName"
									editor="documentNameEditor" width="100px"></kendo:grid-column>
								<kendo:grid-column title="Document Format"
									field="documentFormat" editor="documentFormatEditor"
									width="100px"></kendo:grid-column>
								<kendo:grid-column title="Document Number"
									field="documentNumber" width="100px"></kendo:grid-column>
								<kendo:grid-column title="Document Description&nbsp;*"
									field="documentDescription" editor="documentDecriptionEditor"
									width="100px"></kendo:grid-column>
							...
							<kendo:dataSource requestEnd="DocumentOnRequestEnd" requestStart="DocumentsRequestStart">
								<kendo:dataSource-transport>
									<kendo:dataSource-transport-read
										url="${OwnerPropertyDRReadUrl}/#=drGroupId#/Domestic Help" dataType="json"
										type="POST" contentType="application/json" />
									<kendo:dataSource-transport-create
										url="${OwnerDocumentRepoCreateUrl}/#=drGroupId#/Domestic Help"
										dataType="json" type="POST" contentType="application/json" />
									<kendo:dataSource-transport-update
										url="${OwnerDocumentRepoUpdateUrl}/#=drGroupId#/Domestic Help"
										dataType="json" type="POST" contentType="application/json" />
									<kendo:dataSource-transport-destroy
										url="${OwnerDocumentRepoDeleteUrl}" dataType="json"
										type="POST" contentType="application/json" />
									<kendo:dataSource-transport-parameterMap>
										<script type="text/javascript">
											function parameterMap(options, type) {
								...
								<kendo:dataSource-schema>
									<kendo:dataSource-schema-model id="drId">
										<kendo:dataSource-schema-model-fields>
											<kendo:dataSource-schema-model-field name="drId"
												editable="false" />
											<kendo:dataSource-schema-model-field name="documentFormat"
												type="string"></kendo:dataSource-schema-model-field>
											<kendo:dataSource-schema-model-field name="documentName"
												type="string"></kendo:dataSource-schema-model-field>
											<kendo:dataSource-schema-model-field name="documentNumber"
												type="string"></kendo:dataSource-schema-model-field>
											<kendo:dataSource-schema-model-field
			...
			<kendo:tabStrip-item text="Medical Emergency">
				<kendo:tabStrip-item-content>
					<div class="wethear" >
						<kendo:grid remove="deleteAccessCheckMedicalEmergencyDomesticHelp"
							name="gridMedicalEmergencyDomesticHelp_#=personId#"
							pageable="true" edit="medicalEmergencyEventDomesticHelp"
							resizable="true" sortable="true" reorderable="true"
							selectable="true" scrollable="true">
							<kendo:grid-pageable pageSize="5">
								<kendo:grid-pageable-messages
									itemsPerPage="Medical Emergency Details per page"
									empty="No Medical Emergency Detail to display"
									refresh="Refresh all the Medical Emergency Details"
									display="{0} - {1} of {2} Medical Emergency Details"
									first="Go to the first page of Medical Emergency Details"
									last="Go to the last page of Medical Emergency Details"
									next="Go to the next page of Medical Emergency Details"
									previous="Go to the previous page of Medical Emergency Details" />
							</kendo:grid-pageable>
							<kendo:grid-editable mode="popup"
								confirmation="Are you sure you want to remove this Medical Emergency detail?" />
							<kendo:grid-toolbar>
								<kendo:grid-toolbarItem name="create"
									text="Add Medical Emergency Detail" />
							</kendo:grid-toolbar>
							<kendo:grid-columns>
								<%-- <kendo:grid-column title="Medical Emergency ID" field="meId" filterable="false" width="100px"/> 
					        	<kendo:grid-column title="Person Id" field="personId" filterable="true" width="100px" /> --%>
								<kendo:grid-column title="Category&nbsp;*" field="meCategory"
									width="100px">
									<kendo:grid-column-values value="${meCategory}" />
								</kendo:grid-column>
								<kendo:grid-column title="Emergency / Disability Type&nbsp;*"
									field="disabilityType" width="100px" />
								<kendo:grid-column title="Description" field="description"
									editor="textAreaEditor" width="100px" />
								<kendo:grid-column title="Hospital Name" field="meHospitalName"
									width="100px" />
								<kendo:grid-column title="Hospital Contact No"
									field="meHospitalContact" width="100px" />
								<kendo:grid-column title="Hospital Address"
									field="meHospitalAddress" editor="textAreaEditor" width="100px" />
							...
							<kendo:dataSource
								requestStart="onRequestStartMedicalEmergencyDomesticHelp"
								requestEnd="onRequestEndMedicalEmergencyDomesticHelp">
								<kendo:dataSource-transport>
									<kendo:dataSource-transport-read
										url="${readMedicalEmergencyDisabilityUrl}/#=personId#"
										dataType="json" type="POST" contentType="application/json" />
									<kendo:dataSource-transport-create
										url="${createMedicalEmergencyDisabilityUrl}/#=personId#"
										dataType="json" type="POST" contentType="application/json" />
									<kendo:dataSource-transport-update
										url="${updateMedicalEmergencyDisabilityUrl}/#=personId#"
										dataType="json" type="POST" contentType="application/json" />
									<kendo:dataSource-transport-destroy
										url="${deleteMedicalEmergencyDisabilityUrl}"
										dataType="json" type="POST" contentType="application/json" />
									<kendo:dataSource-transport-parameterMap>
										<script type="text/javascript">
											function parameterMap(options, type) {
								...
								<kendo:dataSource-schema>
									<kendo:dataSource-schema-model id="meId">
										<kendo:dataSource-schema-model-fields>
											<kendo:dataSource-schema-model-field name="meId"
												editable="false" />
											<kendo:dataSource-schema-model-field name="personId"
												editable="false" />
											<kendo:dataSource-schema-model-field name="meCategory"
												defaultValue="Emergency" />
											<kendo:dataSource-schema-model-field name="disabilityType"
												type="string">
												<%-- <kendo:dataSource-schema-model-field-validation
													required="true" /> --%>
											</kendo:dataSource-schema-model-field>
											<kendo:dataSource-schema-model-field name="description"
												type="string" />
											<kendo:dataSource-schema-model-field name="meHospitalName"
												type="string" />
											<kendo:dataSource-schema-model-field name="meHospitalContact"
												type="string" />
											<kendo:dataSource-schema-model-field name="meHospitalAddress"
												type="string" />
			...
			<kendo:tabStrip-item text="Arms">
				<kendo:tabStrip-item-content>
					<div class="wethear" >
						<kendo:grid remove="deleteAccessCheckArmsDomesticHelp"
							name="gridArmsDomesticHelp_#=personId#" pageable="true"
							resizable="true" edit="armsEventDomesticHelp" sortable="true"
							reorderable="true" selectable="true" scrollable="true">
							<kendo:grid-pageable pageSize="5">
								<kendo:grid-pageable-messages itemsPerPage="Arms per page"
									empty="No Arms to display" refresh="Refresh all the Arms"
									display="{0} - {1} of {2} Arms"
									first="Go to the first page of Arms"
									last="Go to the last page of Arms"
									next="Go to the next page of Arms"
									previous="Go to the previous page of Arms" />
							</kendo:grid-pageable>
							<kendo:grid-editable mode="popup"
								confirmation="Are you sure you want to remove this Arms?" />
							<kendo:grid-toolbar>
							...
							<kendo:grid-columns>
					        	...
					        	<kendo:grid-column title="Person Id" field="personId" filterable="true" width="100px" /> --%>
								<kendo:grid-column title="Type&nbsp;*" field="typeOfArm"
									editor="comboBoxChecksEditorDomesticHelp" width="100px" />
								<kendo:grid-column title="Make" field="armMake" width="100px" />
								<kendo:grid-column title="Licence No" field="licenceNo"
									width="120px" />

								<kendo:grid-column title="Licence Validity"
									field="licenceValidity" format="{0:dd/MM/yyyy}" width="120px" />
								<%-- <kendo:grid-column title="Dr Group Id" field="drGroupId"  width="120px" /> --%>
								<kendo:grid-column title="Issuing Authority Name"
									field="issuingAuthority" width="120px" />
								<kendo:grid-column title="No Of Rounds" field="noOfRounds"
									format="" width="100px" />
							...
							<kendo:dataSource requestStart="onRequestStartArmsDomesticHelp"
								requestEnd="onRequestEndArmsDomesticHelp">
								<kendo:dataSource-transport>
									<kendo:dataSource-transport-read
										url="${readArmsUrl}/#=personId#" dataType="json" type="POST"
										contentType="application/json" />
									<kendo:dataSource-transport-create
										url="${createArmsUrl}/#=personId#" dataType="json" type="POST"
										contentType="application/json" />
									<kendo:dataSource-transport-update
										url="${updateArmsUrl}/#=personId#" dataType="json" type="POST"
										contentType="application/json" />
									<kendo:dataSource-transport-destroy
										url="${deleteArmsUrl}" dataType="json" type="POST"
										contentType="application/json" />
									<kendo:dataSource-transport-parameterMap>
										<script type="text/javascript">
											function parameterMap(options, type) {
								...
								<kendo:dataSource-schema>
									<kendo:dataSource-schema-model id="armsId">
										<kendo:dataSource-schema-model-fields>
											...
											<kendo:dataSource-schema-model-field name="personId" />
											<kendo:dataSource-schema-model-field name="typeOfArm"
												type="string" defaultValue="Revolver" />
											<kendo:dataSource-schema-model-field name="armMake"
												type="string" />
											<kendo:dataSource-schema-model-field name="licenceNo"
												type="string">
												<kendo:dataSource-schema-model-field-validation
													required="true" />
											</kendo:dataSource-schema-model-field>
											<kendo:dataSource-schema-model-field name="licenceValidity"
												type="date" defaultValue="">
												<kendo:dataSource-schema-model-field-validation
													required="true" />
											</kendo:dataSource-schema-model-field>
											<kendo:dataSource-schema-model-field name="drGroupId"
												type="number" />
											<kendo:dataSource-schema-model-field name="issuingAuthority"
												type="string" />
											<kendo:dataSource-schema-model-field name="noOfRounds"
...
<div id="uploadDialog" title="Upload Image" style="display: none;">
	<kendo:upload complete="oncomplete" name="files"
		upload="onpersonImageUpload" multiple="false" success="onImageSuccess">
...
<div id="dialogBoxforContacts" title="Associated Contacts"></div>
	...
	$("#gridPersonDomesticHelp").on("click",".k-grid-domesticTemplatesDetailsExport", function(e) {
		  window.open("./domesticTemplate/domesticTemplatesDetailsExport");
	});	
	
	$("#gridPersonDomesticHelp").on("click",".k-grid-domesticPdfTemplatesDetailsExport", function(e) {
		  window.open("./domesticPdfTemplate/domesticPdfTemplatesDetailsExport");
	});	  
	...
	$( document ).ready(function() {
		...
		$("#propertyFilters").kendoComboBox({
			...
			dataSource : {
				transport : {
					read : {
						url : "./property/getAllpropertyDomestic",
					}
				}
			}
		});
	...
	function applyFilter(filterField, filterValue) {
		...
		var gridData = $("#gridPersonDomesticHelp").data("kendoGrid");
		...
		$("#gridPersonDomesticHelp")
				.on(
						"click",
						".k-grid-add",
						function(e) {

							/* if ($("#gridPersonDomesticHelp").data("kendoGrid").dataSource
									.filter()) {

								//$("#grid").data("kendoGrid").dataSource.filter({});
								$("form.k-filter-menu button[type='reset']")
										.slice().trigger("click");
								var grid = $("#gridPersonDomesticHelp").data(
										"kendoGrid");
		...
		function personEventDomesticHelp(e) {
			...
			if (e.model.isNew()) {
				...
				securityCheckForActions("./commanagement/domestichelpproperty/createButton");

				$(".k-window-title").text("Add New Domestic Help Record");
				$(".k-grid-update").text("Save");
			} else {

				securityCheckForActions("./commanagement/domestichelpproperty/updateButton");
				$(".k-window-title").text("Edit Domestic Help Details");
			}
		...
		function clearFilterDomesticHelp() {
			$("#propertyFilters").data("kendoComboBox").value("");
			applyFilter("personName","");
			$("form.k-filter-menu button[type='reset']").slice().trigger(
					"click");
			var gridPersonDomesticHelp = $("#gridPersonDomesticHelp").data(
					"kendoGrid");
			gridPersonDomesticHelp.dataSource.read();
			gridPersonDomesticHelp.refresh();
		}
					...
					.extend(
							...
							kendo.ui.validator,
							{
								rules : { // custom rules          	
									...
									middleNameSpacesvalidation : function(
											input, params) {
										if (input.filter("[name='middleName']").length
												&& input.val()) {
											if (input.val().trim() == "") {
									...
									fatherNameSpacesvalidation : function(
											input, params) {
										if (input.filter("[name='fatherName']").length
												&& input.val()) {
											if (input.val().trim() == "") {
									...
									dob : function(input, params) {
										if (input.filter("[name = 'dob']").length
												&& input.val()) {
		...
		var SelectedRowId = "";
		var SelectedGroupId = "";
		function onChangeDomesticHelp(arg) {
			var gview = $("#gridPersonDomesticHelp").data("kendoGrid");
		...
		function firstNameEditorDomesticHelp(container, options) {
		...
		function UserSelectedAuto(e) {
			...
			var grid = $("#gridPersonDomesticHelp").data("kendoGrid");
			grid.cancelRow();
			$.ajax({
				type : "POST",
				url : "./person/getPersonDetails/" + personId + "/"
						+ personStyle,
		...
		function saveExistingId(personId) {
			...
			$
					.ajax({
						...
						data : {
							personId : personId,
							personType : "DomesticHelp",
						},
						success : function(response) {
							var text = response.search('already');
							if (parseInt(text) <= 0) {
								$('#gridPersonDomesticHelp').data().kendoGrid.dataSource
										.read();
		...
		function ageDisplay(data) {
			if ((data.dob == null) || (data.dob == "")) {
				...
				return kendo.toString(new Date(), 'yyyy')
						- kendo.toString(data.dob, 'yyyy');
			}
		}

		function comboBoxChecksEditorDomesticHelp(container, options) {
			var res = (container.selector).split("=");
			var attribute = res[1].substring(0, res[1].length - 1);

			$("<select data-bind='value:" + attribute + "'/>").appendTo(
		...
		$("#gridPersonDomesticHelp")
				.on(
						...
						function(e) {
							...
							var widget = $("#gridPersonDomesticHelp").data(
									"kendoGrid");
							...
							$
									.ajax({
										type : "POST",
										url : "./commanagement/domestichelp/deleteButton",
										dataType : 'text',
										success : function(response) {
											if (response == "false") {
												var grid = $(
												...
												if (enable) {
													$
															.ajax({
																type : "POST",
																url : "./person/personStatus/"
																		+ dataItem.id
																		+ "/activate/DomesticHelp",
																success : function(
																		response) {
																	$(
																			"#alertsBox")
		...
		function onRequestStartPersonDomesticHelp(e) {
		 	$('.k-grid-update').hide();
			$('.k-edit-buttons')
					.append(
		...
		/* 	
			var gridPerson = $("#gridPersonDomesticHelp").data("kendoGrid");
			if (gridPerson != null) {
				gridPerson.cancelRow();
			}  */
		}

		function onRequestEndPersonDomesticHelp(e) {
			displayMessage(e, "gridPersonDomesticHelp", "Domestic Help");
		}
	</script>
	<!-- ---------------------------------------------- Address script -------------------------------------- -->
	<script type="text/javascript">
							...
							kendo.ui.validator,
							{
								rules : { // custom rules          	
									addressSeasonFrom : function(input, params) {
										if (input
												.filter("[name = 'addressSeasonFrom']").length
												&& input.val() != "") {
											var selectedDate = input.val();
											var todaysDate = $.datepicker
													.formatDate('dd/mm/yy',
									...
									addressSeasonTo1 : function(input, params) {
										if (input
												.filter("[name = 'addressSeasonTo']").length
												&& input.val() != "") {
											var flagDate = false;
									...
									pincodeValidation : function(input, params) {
										if (input.filter("[name='pincode']").length
												&& input.val()) {
											return /^(\s*\d{6}\s*)$/.test(input
													.val());
										}
										return true;
									},
									statevalidation : function(input, params) {
										if (input
												.filter("[name='stateotherId']").length
												&& input.val()) {
											return /^[a-zA-Z ]{1,45}$/
													.test(input.val());
										}
									...
									cityvalidation : function(input, params) {
										if (input
												.filter("[name='cityotherId']").length
												&& input.val()) {
											return /^[a-zA-Z ]{1,45}$/
													.test(input.val());
										}
		...
		function contactInfo() {
			var aId = "";
			var gaddressview = $("#gridAddress_" + SelectedRowId).data(
					"kendoGrid");
			var selectedAddressItem = gaddressview.dataItem(gaddressview
					.select());
					...
					.ajax({
						...
						success : function(response) {
							...
							contactList = contactList
									+ "<th><font color=white>Contact Type</font></th><th><font color=white>Contact Content</font></th><th><font color=white>Primary Contact?</font></th></tr>";

							if (response.length > 0) {
								for (var s = 0, len = response.length; s < len; ++s) {
									var contact = response[s];
									contactList += "<tr><td align=center>"
											+ contact.contactType
											+ "</td><td align=center>"
		...
		function addressLocationEditor(container, options) {
			$(
					'<input name="Address Location" data-bind="value:' + options.field + '" required="true"/>')
			...
			$('<span class="k-invalid-msg" data-for="Address Location"></span>')
					.appendTo(container);
		}

		function addressPrimaryEditor(container, options) {
			$(
					'<input name="Address Primary" id="addressPrimary" data-bind="value:' + options.field + '" required="true"/>')
					.appendTo(container).kendoDropDownList({
						dataTextField : "value",
						dataValueField : "name",
						dataSource : {
			...
			$('<span class="k-invalid-msg" data-for="Address Primary"></span>')
					.appendTo(container);
		}
		...
		function countryEditor(container, options) {
			...
			$('<span class="k-invalid-msg" data-for="Country Name"></span>')
					.appendTo(container);
		}
		...
		$(document)
				.on(
						...
						function() {
							...
							if (test == "") {
								$('input[name="addressSeasonTo"]').prop(
										'required', false);
								$('input[name="addressSeasonFrom"]').prop(
										'required', false);
		...
		function addressEvent(e) {
			...
			if (e.model.isNew()) {
				...
				securityCheckForActions("./commanagement/domestichelpaddress/createButton");
				...
				var addressGrid = $("#gridAddress_" + SelectedRowId).data(
						"kendoGrid");
				...
				for (var i = 0; i < addressGriddata.length; i++) {
					...
					if (addressGriddata[i].addressPrimary == "Yes") {
						...
						var dropdownlist = $("#addressPrimary").data(
								"kendoDropDownList");
						dropdownlist.search('Yes');
						dropdownlist.readonly();
						var addressPrimary = $("#gridAddress_" + SelectedRowId)
				...
				securityCheckForActions("./commanagement/domestichelpaddress/updateButton");
				...
				$('label[for="emailContent"]').closest('.k-edit-label')
						.remove();
				$('div[data-container-for="emailContent"]').remove();

				$('label[for="phoneContent"]').closest('.k-edit-label')
						.remove();
				...
				if (test == "on") {
					$('label[for="addressSeasonFrom"]').show();
					$('div[data-container-for="addressSeasonFrom"]').show();

					$('label[for="addressSeasonTo"]').show();
					$('div[data-container-for="addressSeasonTo"]').show();
		...
		function removeAddress(){
			securityCheckForActions("./commanagement/domestichelpaddress/deleteButton");
		}
		
		function removeContact(){
			securityCheckForActions("./commanagement/domestichelpcontact/deleteButton");
		}
	</script>
	...
	<script type="text/javascript">
		...
		function contactEvent(e) {
			...
			if (e.model.isNew()) {
				...
				var addUrl = "./commanagement/domestichelpcontact/createButton";
				...
				var editUrl = "./commanagement/domestichelpcontact/updateButton";
				var gridName = "#gridContact_" + SelectedRowId;
			...
			$(".k-grid-update")
					.click(
							function() {
								var contactType = $(
										'select[class="contactType"] :selected')
										.text();
								var contactContent = $(
										'input[name="contactContent"]').val();
								var contactPrimaryStatus = $(
										'select[id="contactPrimary"] :selected')
										.text();
								if (addOrEdit === 1) {
									var contactGrid = $(
											"#gridContact_" + SelectedRowId)
											.data("kendoGrid");
									var contactGriddata = contactGrid.dataSource
											.data();
									for (var i = 1; i < contactGriddata.length; i++) {
										if (contactGriddata[i].contactPrimary == "Yes"
												&& contactGriddata[i].contactType == contactType
												&& contactPrimaryStatus == 'Yes') {
											YesExists = 1;
											alert("  Primary Contact is already Exists for "
													+ contactType
													+ "\n\nThis "
													+ contactType
													+ " contact will be your secondary contact");
											var dropdownlist = $(
													"#contactPrimary").data(
													"kendoDropDownList");
											dropdownlist.search('Yes');
								...
								if (!$.isNumeric(contactContent)
										&& ((contactType === 'Mobile')
												|| (contactType === 'HomePhone') || (contactType === 'Intercom'))) {
									alert("Please enter valid " + contactType
											+ " Number");
									return false;
								}
								...
								if ($.isNumeric(contactContent)
										&& (contactType === 'Mobile')
										&& contactContent.length != 10) {
									alert("Please enter valid 10 digit "
											+ contactType + " Number");
									return false;
								}

								var emailReg = /^([\w-\.]+@([\w-]+\.)+[\w-]{2,4})?$/;
								if (!emailReg.test(contactContent)
										&& contactType === 'Email') {
	...
	<script type="text/javascript">
		function parse(response) {
			$.each(response, function(idx, elem) {
				if (elem.startDate && typeof elem.startDate === "string") {
					elem.startDate = kendo.parseDate(elem.startDate,
							"yyyy-MM-ddTHH:mm:ss.fffZ");
				}
				if (elem.endDate && typeof elem.endDate === "string") {
					elem.endDate = kendo.parseDate(elem.endDate,
							"yyyy-MM-ddTHH:mm:ss.fffZ");
				}
			});
			return response;
		...
		function workNatureEditor(container, options) {
			$(
					'<select name="Work Nature" data-text-field="name" id="staffType" data-value-field="value" data-bind="value:' + options.field + '" required="true"/>')
			...
			$('<span class="k-invalid-msg" data-for="Work Nature"></span>')
					.appendTo(container);
		}
		...
		function TowerNames(container, options) {
			$(
					'<input name="Tower Name" data-text-field="blockName"  data-value-field="blockId" id="blockId" data-bind="value:' + options.field + '" required="true"/>')
					.appendTo(container).kendoDropDownList({
						optionLabel : "Select",
						dataSource : {
							transport : {
			...
			$('<span class="k-invalid-msg" data-for="Tower Name"></span>')
					.appendTo(container);
		}
		function propertyNoEditor(container, options) {
			$(
					'<input name="PropertyNo" data-text-field="propertyNo" data-value-field="propertyId" data-bind="value:' + options.field + '" required="true"/>')
					.appendTo(container).kendoDropDownList({
						optionLabel : "Select",
						cascadeFrom : "blockId",
						dataSource : {
			...
			$('<span class="k-invalid-msg" data-for="PropertyNo"></span>')
					.appendTo(container);
		}
			...
			if (typeof e.response != 'undefined') {
				...
				if (e.response.status == "FAIL") {
					...
					if (e.type == "create") {
						...
						$("#alertsBox").html("");
						$("#alertsBox").html(
								"Error: Assigning property to Tenant<br>"
										+ errorInfo);
						$("#alertsBox").dialog({
							modal : true,
							buttons : {
					...
					grid.refresh();
					return false; */
					$('#grid2_' + SelectedRowId).data().kendoGrid.dataSource
							.read();
					...
					if (e.type == "create") {
						$("#alertsBox").html("");
						$("#alertsBox").html(
								"Error: Assigning property to Domestic<br> "
										+ errorInfo);
						$("#alertsBox").dialog({
							modal : true,
							buttons : {
					...
					if (e.type == "update") {
						$("#alertsBox").html("");
						$("#alertsBox").html(
								"Error: Updating property to Domestic Help<br> "
										+ errorInfo);
						$("#alertsBox").dialog({
							modal : true,
							buttons : {
	...
	<script type="text/javascript">
		function accessCardsEditor(container, options) {
			...
			$('<span class="k-invalid-msg" data-for="acNo"></span>').appendTo(
					container);
		}
		function accessCardEvent(e) {
			...
			if (e.model.isNew()) {
				securityCheckForActions("./commanagement/domestichelpacesscards/createButton");
				$(".k-window-title").text("Add New Access Card Record");
				$(".k-grid-update").text("Save");
				$('.k-edit-field .k-input').first().focus();
			} else {
				securityCheckForActions("./commanagement/domestichelpacesscards/updateButton");
							...
							kendo.ui.validator,
							{
								rules : { // custom rules          	
									acStartDate : function(input, params) {
										if (input
												.filter("[name = 'acStartDate']").length
												&& input.val() != "") {
											var selectedDate = input.val();
											var todaysDate = $.datepicker
													.formatDate('dd/mm/yy',
		...
		function accessCardTypeEditor(container, options) {
			...
			$('<span class="k-invalid-msg" data-for="Card Type"></span>')
					.appendTo(container);
			...
			if (typeof e.response != 'undefined') {
				...
				if (e.response.status == "FAIL") {
					...
					if (e.type == "create") {
						$("#alertsBox").html("");
						$("#alertsBox").html(
								"Error: Assigning the AccessCard<br>"
										+ errorInfo);
						$("#alertsBox").dialog({
							modal : true,
							buttons : {
						...
						$("#alertsBox").html("");
						$("#alertsBox").html(
								"Error: Updating the AccessCard<br>"
										+ errorInfo);
						$("#alertsBox").dialog({
							modal : true,
							buttons : {
	...
	<script type="text/javascript">
							...
							kendo.ui.validator,
							{
								rules : { // custom rules          	
									acpStartDate : function(input, params) {
										if (input
												.filter("[name = 'acpStartDate']").length
												&& input.val() != "") {
											var selectedDate = input.val();
											var todaysDate = $.datepicker
													.formatDate('dd/mm/yy',
									...
									acpEndDate2 : function(input, params) {
										if (input
											...
											if ($.datepicker.parseDate(
													'dd/mm/yy', selectedDate) > $.datepicker
													.parseDate('dd/mm/yy',
															seasonFromAccessCardPermission)) {
												flagDate = true;
											}
											return flagDate;
										}
									...
									AccessPointUniqueness : function(input,
											params) {
										if (input
												.filter("[name='AccessRepository']").length
												&& input.val()) {
											var flag = true;
											$.each(accessPointsId, function(
													idx1, elem1) {
		...
		function accessCardPermissionEvent(e) {
			...
			if (e.model.isNew()) {
				...
				securityCheckForActions("./commanagement/domestichelpacesscardspermission/createButton");
				...
				if ((SelectedAccessCardId == "")
						|| (SelectedAccessCardId == ' ')) {
					var grid = $("#gridAccessCardPermission_" + SelectedRowId)
							.data("kendoGrid");
					grid.cancelRow();
					$("#alertsBox").html("");
				...
				securityCheckForActions("./commanagement/domestichelpacesscardspermission/updateButton");
			...
			e.container
					...
					.bind(
							...
							function() {
								//your code here
								var gridAccessCardPermission = $(
										"#gridAccessCardPermission_"
												+ SelectedRowId).data(
										"kendoGrid");
		...
		function accessRepoEditor(container, options) {
			...
			$('<span class="k-invalid-msg" data-for="AccessRepository"></span>')
					.appendTo(container);
		...
		function AccessCardsPermissionRequestEnd(e) {
			if (typeof e.response != 'undefined') {
				...
				if (e.response.status == "FAIL") {
					...
					$("#alertsBox").html("");
					$("#alertsBox").html(
							"Assigning Permission updated successfully");
					$("#alertsBox").dialog({
						modal : true,
						buttons : {
							"Close" : function() {
					...
					$("#alertsBox").html("");
					$("#alertsBox")
							.html("Access Point Unassigned Successfully");
					$("#alertsBox").dialog({
						modal : true,
						buttons : {
							"Close" : function() {
	...
	<script type="text/javascript">
		...
		function UploadFileBound(e) {
			...
			if(kycCompliant !=null)
			{
		 	...
		 	var found = $.inArray('DomesticHelp', tempArray) > -1;
		 	if(found)
		 		{
			...
			this.tbody.find("tr td:first-child").each(
					function(e) {
						$("<input type='file' name='files'  />").appendTo(this)
								.kendoUpload({
									async : {
										saveUrl : "${saveUrl}",
										removeUrl : "remove",
		...
		function documentNameEditor(container, options) {
			$(
					...
					.appendTo(container).kendoDropDownList({
						...
						dataSource : {
							transport : {
								read : "${getDocumentType}/Domestic Help"
							}
						}
					});
			$('<span class="k-invalid-msg" data-for="Document Name"></span>')
					.appendTo(container);
		}
			...
			$
					.ajax({
						...
						success : function(response) {
							...
							var documentFormat = $(
									"#documentsUpload_" + SelectedRowId).data().kendoGrid.dataSource
		...
		function uploadNotice() {
			var gview = $("#documentsUpload_" + SelectedRowId)
					.data("kendoGrid");
		...
		function downloadFile() {
			/* var result=securityCheckForActionsForStatus("./commanagement/domestichelpaddressdocuments/viewButton");
			if(result=="success")
			{ */
		...
		function DocumentOnRequestEnd(e) {
			if (typeof e.response != 'undefined') {
				...
				if (e.response.status == "FAIL") {
					...
					$("#alertsBox").html("");
					$("#alertsBox")
							.html("Document Record Created Successfully");
					$("#alertsBox").dialog({
						modal : true,
						buttons : {
							"Close" : function() {
					...
					$("#alertsBox").html("");
					$("#alertsBox")
							.html("Document Record updated successfully");
					$("#alertsBox").dialog({
						modal : true,
						buttons : {
							"Close" : function() {
							...
							kendo.ui.validator,
							{
								rules : { // custom rules          	
									documentNumber : function(input, params) {
										if (input
												.filter("[name = 'documentNumber']").length
												&& input.val() != "") {
									...
									documentDescription : function(input,
											params) {
										if (input
												.filter("[name = 'documentDescription']").length
												&& input.val() != "") {
									...
									documentDescription_blank : function(input,
											params) {
										//check for the name attribute 
		...
		function documentEvent(e) {
			...
			if (e.model.isNew()) {
				securityCheckForActions("./commanagement/domestichelpaddressdocuments/createButton");
				selectedRowIndex = 0;
				$(".k-window-title").text("Add New Document Details");
				$(".k-grid-update").text("Save");
				$('.k-edit-field .k-input').first().focus();
			} else {
				securityCheckForActions("./commanagement/domestichelpaddressdocuments/updateButton");
		...
		function approveDocuments()
		{
			...
			if (r == true && totalRecords > 0) 
			{
				$.ajax({
					type : "POST",
					dataType:"text",
					url : "./documents/checkFile/"+SelectedGroupId+"/DomesticHelp/",
					success : function(response)
					{
						 if( response == "FILEENOTEXISTS" ){
							...
							$.ajax({
								type : "POST",
								url : "./documents/checkAllDocument/"+SelectedGroupId+"/DomesticHelp/",
								dataType:"text",
								success : function(response)
								{	
				...
				$.ajax({
					type : "POST",
					url : "./documents/approve/"+SelectedRowId+"/DomesticHelp/"+kycCompliant,
					success : function(response)
					{
						$("#alertsBox").html("");
						$("#alertsBox").html(response);
	...
	<script type="text/javascript">
		function medicalEmergencyEventDomesticHelp(e) {
			if (e.model.isNew()) {
				securityCheckForActions("./commanagement/domestichelpaddressmedicalemergency/createButton");

				$(".k-window-title").text("Add New Medical Emergency Details");
				$('.k-edit-field .k-input').first().focus();
				$(".k-grid-update").text("Save");
			} else {
				securityCheckForActions("./commanagement/domestichelpaddressmedicalemergency/updateButton");
		...
		(function($, kendo) {
			$
					.extend(
							...
							{
								rules : { // custom rules
									disabilityTypeSpcacesvalidation : function(
											input, params) {
										if (input
												.filter("[name='disabilityType']").length
												&& input.val()) {
											if (input.val().trim() == "") {
												return false;
											}
									...
									disabilityTypevalidation : function(input,
											params) {
										if (input
												.filter("[name='disabilityType']").length
												&& input.val()) {
											return /^[a-zA-Z0-9 ]{0,45}$/
													.test(input.val());
										}
										return true;
									},
									descriptionSpcacesvalidation : function(
											input, params) {
										if (input
												.filter("[name='description']").length
												&& input.val()) {
											if (input.val().trim() == "") {
												return false;
											}
									...
									meHospitalNameSpcacesvalidation : function(
											input, params) {
										if (input
												.filter("[name='meHospitalName']").length
												&& input.val()) {
											if (input.val().trim() == "") {
												return false;
											}
									...
									meHospitalNamevalidation : function(input,
											params) {
										if (input
												.filter("[name='meHospitalName']").length
												&& input.val()) {
									...
									meHospitalContactSpcacesvalidation : function(
											input, params) {
										if (input
												.filter("[name='meHospitalContact']").length
												&& input.val()) {
											if (input.val().trim() == "") {
												return false;
											}
									...
									meHospitalContactvalidation : function(
											input, params) {
										if (input
												.filter("[name='meHospitalContact']").length
												&& input.val()) {
									...
									meHospitalAddressSpcacesvalidation : function(
											input, params) {
										if (input
												.filter("[name='meHospitalAddress']").length
												&& input.val()) {
											if (input.val().trim() == "") {
												return false;
											}
		...
		function deleteAccessCheckMedicalEmergencyDomesticHelp(e) {
			  securityCheckForActions("./commanagement/domestichelpaddressmedicalemergency/createButton");
		}

		function onRequestStartMedicalEmergencyDomesticHelp(e) {
			...
			/*var gridMedicalEmergency = $(
					'#gridMedicalEmergencyDomesticHelp_' + res[res.length - 1])
					.data("kendoGrid");
 ...
 */		}
		...
		function onRequestEndMedicalEmergencyDomesticHelp(e) {
			var res = (e.sender.options.transport.read.url).split("/");
			displayMessage(e, 'gridMedicalEmergencyDomesticHelp_'
					+ res[res.length - 1], "Medical Emergency");
		}
		
		//all Child's reqStarts
	...
	<!-- -------------------------------------------------- Arms script ----------------------------------- -->
	<script type="text/javascript">
		function armsEventDomesticHelp(e) {
			if (e.model.isNew()) {
				
				securityCheckForActions("./commanagement/domestichelparms/createButton");
				
				$.ajax({
					type : "POST",
					url : "./documents/documentCheckForArms/"+SelectedGroupId+"/DomesticHelp/",
					dataType:"text",
					success : function(response)
					{
						...
						if( response == "ARMSDOCUMENTNOTFOUND" ){
							...
							var gridArms = $("#gridArmsDomesticHelp_"+ SelectedRowId).data("kendoGrid");
								gridArms.cancelRow();
						}
				...
				securityCheckForActions("./commanagement/domestichelparms/updateButton");
			...
			$(".k-grid-update")
					.click(
							function() {
								var typeOfArm = $(
										"select[data-bind='value:typeOfArm'] :selected")
										.val();
							...
							kendo.ui.validator,
							{
								rules : {
									...
									armMakevalidation : function(input, params) {
										if (input.filter("[name='armMake']").length
												&& input.val()) {
											return /^[a-zA-Z0-9 ]{0,45}$/
													.test(input.val());
										}
									...
									armMakeSpacesvalidation : function(input,
											params) {
										if (input.filter("[name='armMake']").length
												&& input.val()) {
											if (input.val().trim() == "") {
									...
									licenceNoSpacesvalidation : function(input,
											params) {
										if (input.filter("[name='licenceNo']").length
												&& input.val()) {
											if (input.val().trim() == "") {
												return false;
											}
									...
									noOfRoundsSizevalidation : function(input,
											params) {
										if (input.filter("[name='noOfRounds']").length
												&& input.val()) {
									...
									issuingAuthorityvalidation : function(
											input, params) {
										if (input
												.filter("[name='issuingAuthority']").length
												&& input.val()) {
											return /^[a-zA-Z ]{1,45}$/
													.test(input.val());
										}
									...
									issuingAuthoritySpacesvalidation : function(
											input, params) {
										if (input
												.filter("[name='issuingAuthority']").length
												&& input.val()) {
									...
									licenceValidity : function(input, params) {
										if (input
												.filter("[name = 'licenceValidity']").length
												&& input.val()) {
											var selectedDate = input.val();
											var todaysDate = $.datepicker
													.formatDate('dd/mm/yy',
		...
		function deleteAccessCheckArmsDomesticHelp(e)
		{
			securityCheckForActions("./commanagement/domestichelparms/deleteButton");
		}
							
		function removeAccessCard(e){
			securityCheckForActions("./commanagement/domestichelpacesscards/deleteButton");
		}
							
		function removeAccessCardPermission(e){
			securityCheckForActions("./commanagement/domestichelpacesscardspermission/deleteButton");
		}
							
		function removeDocument(e){
			securityCheckForActions("./commanagement/domestichelpaddressdocuments/deleteButton");							
		}

		function onRequestStartArmsDomesticHelp(e) {
			...
			$('.k-grid-cancel').hide();
			var res = (e.sender.options.transport.read.url).split("/");
			/* var gridArms = $('#gridArmsDomesticHelp_' + res[res.length - 1])
					.data("kendoGrid");
			if (gridArms != null) {
				gridArms.cancelRow();
			} */
		...
		function onRequestEndArmsDomesticHelp(e) {
			var res = (e.sender.options.transport.read.url).split("/");

			displayMessage(e, 'gridArmsDomesticHelp_' + res[res.length - 1],
					"Arms");
		}
	</script>
