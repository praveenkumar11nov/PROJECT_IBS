...
<script type="text/javascript" lang="JavaScript" src="<c:url value='/resources/jquery.i18n.properties-min-1.0.9.js'/>"></script>
...
<div id="content">
	...
	<div class="wrapper">
		...
		<c:choose>
			...
			<c:when test="${viewName == 'Service Masters'}">
				<ul class="middleNavA">								
					<li><a title="Service Master" href="#"
						onclick="RenderLinkInner('serviceMaster')"> <img alt=""
							src="<c:url value='/resources/images/billing/servicePoints/serviceMasterImg.png'/>">
			...
			<c:when test="${viewName == 'Service Master'}">
				<ul class="middleNavA">								
					<li><a title="Service Master" href="#"
						onclick="RenderLinkInner('serviceMaster')"> <img alt=""
							src="<c:url value='/resources/images/billing/servicePoints/serviceMasterImg.png'/>">
