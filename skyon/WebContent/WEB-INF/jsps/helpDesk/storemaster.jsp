...
<c:url value="/storemaster/Create" var="createUrl" />
<c:url value="/storemaster/Read" var="readUrl" />
...
<kendo:grid name="storeGrid" pageable="true" resizable="true" sortable="true" reorderable="true" selectable="true" scrollable="true"  edit="StoreGridEvent">
		...
		<kendo:grid-column title="Store Name*" field="storeName" width="120px" >
		...
		<kendo:grid-column title="Store Number*" field="storeNum" width="120px" >
		</kendo:grid-column>
		
		<kendo:grid-column title="Store Description*" field="storeDesc"  editor="DescriptionEditor" width="120px" >
		</kendo:grid-column>
		
		<kendo:grid-column title="Username*" field="username"   width="120px" >
		</kendo:grid-column>
		
		<kendo:grid-column title="Password*" field="password"   width="120px" >
		</kendo:grid-column> 
			 ...
			 <kendo:dataSource-schema>
				<kendo:dataSource-schema-model id="sId">
					...
					<kendo:dataSource-schema-model-field name="sId" type="number" />
						...
						<kendo:dataSource-schema-model-field name="storeNum" type="String"/>
						...
						<kendo:dataSource-schema-model-field name="storeDesc">
...
{
	  $('<textarea name="Store Description" data-text-field="storeDesc" data-value-field="storeDesc" data-bind="value:' + options.field + '" style="width: 161px; height: 46px;" required="true"/>').appendTo(container);
	  $('<span class="k-invalid-msg" data-for="Store Description"></span>').appendTo(container); 
}
