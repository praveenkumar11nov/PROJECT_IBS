...
<div id="loading" ></div>
	...
	<kendo:grid-columns>
		<kendo:grid-column title="Ticket No. &nbsp; *" field="ticketNumber"
			width="110px">
		</kendo:grid-column>
		<kendo:grid-column title="On Behalf Of" filterable="false"
			field="onBeHalfOf" width="110px">
		</kendo:grid-column>
		<kendo:grid-column title="Category &nbsp; *" filterable="false"
			field="category" width="130px">
		</kendo:grid-column>

		<kendo:grid-column title="Sub Category &nbsp; *" filterable="false"
			field="subcategory" width="130px">
		</kendo:grid-column>
		<kendo:grid-column title="Property No. &nbsp; *" field="propertyNo"
			width="110px">
		</kendo:grid-column>
		<kendo:grid-column title="Lodged By" field="createdBy"
			filterable="false" width="110px" />
		<kendo:grid-column title="Opened On" field="ticketCreatedDate"
			filterable="false" width="110px" />
		<kendo:grid-column title="Last Update" field="lastUpdatedDT"
			filterable="false" width="110px" />
		<kendo:grid-column title="Status" field="ticketStatus"
			filterable="false" width="110px" />
		<kendo:grid-column title="Driven By" field="drivenBy"
			filterable="false" width="110px" />
		<%--  <kendo:grid-column title="Serviced By"    field="june" filterable="false" width="110px"/> --%>
		<kendo:grid-column title="Days Issue" field="dayIssue"
			filterable="false" width="110px" />
		<kendo:grid-column title="Last Note" field="lastnotes"
			filterable="false" width="110px" />
	...
	<kendo:dataSource requestStart="requestStart" requestEnd="requestEnd">
		<kendo:dataSource-transport>
			...
			<kendo:dataSource-transport-read url="${readUr}/${data}"
