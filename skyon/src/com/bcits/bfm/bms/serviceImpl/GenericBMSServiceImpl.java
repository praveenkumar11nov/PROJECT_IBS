...
import com.bcits.bfm.bms.service.GenericBMSService;
import com.bcits.bfm.util.BfmLogger;

@Transactional(readOnly = true)
public abstract class GenericBMSServiceImpl<T> implements GenericBMSService<T>{
