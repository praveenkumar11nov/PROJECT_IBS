...
import com.bcits.bfm.amr.service.GenericMSSQLService;
import com.bcits.bfm.util.BfmLogger;

@Transactional(readOnly = true)
public abstract class GenericMSSQLServiceImpl<T> implements GenericMSSQLService<T> {
	...
	public GenericMSSQLServiceImpl() {
