...
@Entity
@Table(name="Tower_C_EB_kwh",schema="dbo",catalog="EMS")
public class Tower_C_EB_kwh {
	// Fields
	...
	/** default constructor */
	public Tower_C_EB_kwh() {
	}

	/** full constructor */
	public Tower_C_EB_kwh(Timestamp datestr, Double s1n282Kwh, Double s1n283Kwh,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof Tower_C_EB_kwh))
			return false;
		Tower_C_EB_kwh castOther = (Tower_C_EB_kwh) other;
