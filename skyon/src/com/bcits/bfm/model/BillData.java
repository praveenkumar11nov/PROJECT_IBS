...
public class BillData
{
	...
	public String toString() {
		return "BillData [mtrSrNo=" + mtrSrNo + ", meterDT=" + meterDT + ", readingDT=" + readingDT + ", activeEnergy="
				+ activeEnergy + ", maxDemandKW=" + maxDemandKW + ", mDDTKW=" + mDDTKW + ", maxDemandKVA="
				+ maxDemandKVA + ", mDDTKVA=" + mDDTKVA + ", poweronhours=" + poweronhours + ", pf=" + pf
				+ ", activeEnergyDG=" + activeEnergyDG + ", maxDemandKWDG=" + maxDemandKWDG + ", mDDTKWDG=" + mDDTKWDG
				+ ", maxDemandKVADG=" + maxDemandKVADG + ", mDDTKVADG=" + mDDTKVADG + ", poweronhoursDG="
