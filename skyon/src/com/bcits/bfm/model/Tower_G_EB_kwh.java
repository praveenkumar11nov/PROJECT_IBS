...
@Entity
@Table(name="Tower_G_EB_kwh",schema="dbo",catalog="EMS")
public class Tower_G_EB_kwh {
	...
	/** default constructor */
	public Tower_G_EB_kwh() {
	}

	/** full constructor */
	public Tower_G_EB_kwh(Timestamp datestr, Double s1n326Kwh, Double s1n327Kwh,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof Tower_G_EB_kwh))
			return false;
		Tower_G_EB_kwh castOther = (Tower_G_EB_kwh) other;
