...
@Entity
@Table(name="Tower_H_DG_kwh",schema="dbo",catalog="EMS")
public class Tower_H_DG_kwh {
	...
	/** default constructor */
	public Tower_H_DG_kwh() {
	}

	/** full constructor */
	public Tower_H_DG_kwh(Timestamp datestr, Double s1n1Kwh, Double s1n2Kwh,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof Tower_H_DG_kwh))
			return false;
		Tower_H_DG_kwh castOther = (Tower_H_DG_kwh) other;
