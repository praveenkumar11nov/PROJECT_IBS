...
@NamedQueries({
	@NamedQuery(name="Tower_A_EB_kwh.findALL" ,query="Select tower from Tower_A_EB_kwh tower")
})
@Entity
@Table(name="Tower_A_EB_kwh",schema="dbo",catalog="EMS")
public class Tower_A_EB_kwh {
	// Fields
	...
	/** default constructor */
	public Tower_A_EB_kwh() {
	}

	/** full constructor */
	public Tower_A_EB_kwh(Timestamp datestr, Double s1n238Kwh, Double s1n239Kwh,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof Tower_A_EB_kwh))
			return false;
		Tower_A_EB_kwh castOther = (Tower_A_EB_kwh) other;
