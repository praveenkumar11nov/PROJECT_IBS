...
public class MailRoomMessenger implements Runnable {
	...
	public MailRoomMessenger(EmailCredentialsDetailsBean emailCredentialsDetailsBean) {
	...
	public void run()
	{
		...
		try {
			...
			message.setSubject("MailRoom Consignments Notification");
