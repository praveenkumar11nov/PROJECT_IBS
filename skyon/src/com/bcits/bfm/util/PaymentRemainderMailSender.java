...
public class PaymentRemainderMailSender implements Runnable {
	
	private final String toAddressEmail;
	private final String messageContent;
	private final String paymentRemainderMailId;
	private final String paymentRemainderMailPwd;
	...
	public PaymentRemainderMailSender(EmailCredentialsDetailsBean emailCredentialsDetailsBean, String mailSubject) {
		...
		this.paymentRemainderMailId=emailCredentialsDetailsBean.getMailId();
		this.paymentRemainderMailPwd=emailCredentialsDetailsBean.getMailIdPwd();
		...
		Session session = Session.getDefaultInstance(props,
			new javax.mail.Authenticator() {
				protected PasswordAuthentication getPasswordAuthentication() {
					return new PasswordAuthentication(paymentRemainderMailId,paymentRemainderMailPwd);
				}
			});
