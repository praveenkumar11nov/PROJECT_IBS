...
public class HeaderFooterForAccStatement extends PdfPageEventHelper
{
	public void onStartPage(PdfWriter writer,Document document) {
		...
		ColumnText.showTextAligned(writer.getDirectContent(),Element.ALIGN_CENTER, new Phrase("ACCOUNT STATEMENT"), rect.getRight(), rect.getTop(), 0);
	}
