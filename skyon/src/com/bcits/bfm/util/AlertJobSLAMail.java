...
public class AlertJobSLAMail implements Runnable {
	...
	public AlertJobSLAMail(String receiverAddress, String ownername,int jobSla, String jobName, String jobNumber) {
		super();
