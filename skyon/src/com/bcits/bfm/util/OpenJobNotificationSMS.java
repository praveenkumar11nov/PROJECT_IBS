...
public class OpenJobNotificationSMS implements Runnable{
	...
	public OpenJobNotificationSMS(SmsCredentialsDetailsBean smsCredentialsDetailsBean)
	{
	...
	public void run() {
		...
		// give all in string
		 post.setQueryString(new NameValuePair[] { 
			     ...
			     new NameValuePair("sms", "Dear "+userName+", a mail from "+message+"  - IREO-BFM  Administration services.")
