...
public class SendMailForMaintenanceDepartment implements Runnable {
	
	static Logger logger = LoggerFactory.getLogger(SendMailForMaintenanceDepartment.class);
	...
	public SendMailForMaintenanceDepartment(EmailCredentialsDetailsBean emailCredentialsDetailsBean) {
	...
	public void run()
	{
		...
		try {
			...
			message.setSubject("Maintenance Services Mail");
